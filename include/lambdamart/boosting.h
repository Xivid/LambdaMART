...
class Boosting {
  ...
  */
  static void ShuffleModels(int start_iter, int end_iter) = 0;

  static void ResetTrainingData(const Dataset* train_data, const ObjectiveFunction* objective_function,
                                 const std::vector<const Metric*>& training_metrics) = 0;
